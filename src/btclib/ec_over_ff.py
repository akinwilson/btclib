...
while True:
    if order * Point(x, y, a, b) == Point(None, None, a, b):
        ...
        print(
            f"Does {order} +1 return us back to generator point {Point(x,y,a,b)}",
            Point(x, y, a, b) == (order + 1) * Point(x, y, a, b),
        )
        break
    else:
        order += 1
...
print(
    f"Does the order \n\n{ORDER:x}\n\nBitcoin generator point form a cyclical group? ",
    ORDER * Point(x, y, a, b) == Point(None, None, a, b),
)
